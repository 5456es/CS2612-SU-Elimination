...
*)
  Fixpoint Lang_WhileDU6_to_WhileDmalloc_Expr
  ...
  | Lang_WhileDU6.EBinop op e1 e2 ty => EBinop op (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e1) (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e2)
  | Lang_WhileDU6.EUnop op e1 ty => EUnop op (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e1)
  | Lang_WhileDU6.EDeref e1 ty => EDeref (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e1)
  | Lang_WhileDU6.EAddrOf e1 ty => EAddrOf (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e1)
  | Lang_WhileDU6.EStructMember e1 field ty =>
        match expr_type_extract e1 with
        | TStruct struct_name =>
          match  find_field_offset ty_env field (ty_env.(struct_info) struct_name) with
          | Some offset => EDeref(EBinop OPlus (EAddrOf (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e1)) (EConst offset))
          | None => EConst 0
          end
        | _ => EConst 0
        end
  | Lang_WhileDU6.EUnionMember e1 field ty =>
        ...
        | TUnion union_name =>
          ...
          | Some offset => EDeref(EBinop OPlus (EAddrOf (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e1)) (EConst 0))
          | None => EConst 0
          end
        | _ => EConst 0
        end
  | Lang_WhileDU6.EPoniter_Struct_Member e1 field ty =>
        ...
        | TPointer (TStruct struct_name) =>
          match  find_field_offset ty_env field (ty_env.(struct_info) struct_name) with
          | Some offset => EDeref(EBinop OPlus (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e1) (EConst offset))
          | None => EConst 0
          end
        | _ => EConst 0
        end
  | Lang_WhileDU6.EPoniter_Union_Member e1 field ty =>
        ...
        | TPointer (TUnion union_name) =>
          match  find_field_offset ty_env field (ty_env.(union_info) union_name) with
          | Some offset => EDeref(EBinop OPlus (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e1) (EConst 0))
          | None => EConst 0
          end
        | _ => EConst 0
        end
  ...
  | Lang_WhileDU6.CAsgnVar X e1 => CAsgnVar X (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e1)
  | Lang_WhileDU6.CAsgnDeref e1 e2 => CAsgnDeref (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e1) (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e2)
  | Lang_WhileDU6.CSeq c1 c2 => CSeq (Lang_WhileDU6_to_WhileDmalloc_com  ty_env c1) (Lang_WhileDU6_to_WhileDmalloc_com  ty_env c2)
  | Lang_WhileDU6.CIf e1 c1 c2 => CIf (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e1) (Lang_WhileDU6_to_WhileDmalloc_com ty_env c1) (Lang_WhileDU6_to_WhileDmalloc_com ty_env c2)
  | Lang_WhileDU6.CWhile e1 c1 => CWhile (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e1) (Lang_WhileDU6_to_WhileDmalloc_com ty_env c1)
  | Lang_WhileDU6.CDeclare X ty => CDeclare X (ty_env.(type_size) ty)
  |Lang_WhileDU6.CAsgnBasedOnExp X e1 => CAsgnDeref (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env X) (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e1)
  end.
...
*)
  ...
  | Lang_WhileDU6.EDeref e1 ty => EDeref (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e1)
  | Lang_WhileDU6.EAddrOf e1 ty => EAddrOf (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e1)
  | Lang_WhileDU6.EStructMember e1 field ty => EAddrOf (Lang_WhileDU6_to_WhileDmalloc_Expr ty_env e1) 
  ...
  match c1 with
  | Lang_WhileDU6.CSkip => CSkip
  | Lang_WhileDU6.CAsgnVar X e1 => CAsgnVar X (Lang_WhileDU6_to_WhileDmalloc_Expr e1)
  | Lang_WhileDU6.CAsgnDeref e1 e2 => CAsgnDeref (Lang_WhileDU6_to_WhileDmalloc_Expr e1) (Lang_WhileDU6_to_WhileDmalloc_Expr e2)
  | Lang_WhileDU6.CSeq c1 c2 => CSeq (Lang_WhileDU6_to_WhileDmalloc_com  ty_env c1) (Lang_WhileDU6_to_WhileDmalloc_com  ty_env c2)
  | Lang_WhileDU6.CIf e1 c1 c2 => CIf (Lang_WhileDU6_to_WhileDmalloc_Expr e1) (Lang_WhileDU6_to_WhileDmalloc_com ty_env c1) (Lang_WhileDU6_to_WhileDmalloc_com ty_env c2)
  | Lang_WhileDU6.CWhile e1 c1 => CWhile (Lang_WhileDU6_to_WhileDmalloc_Expr e1) (Lang_WhileDU6_to_WhileDmalloc_com ty_env c1)
  | Lang_WhileDU6.CDeclare X ty => CDeclare X (ty_env.(type_size) ty)
...
>>>>>>> 4d0d981832a0d39091c1df08d45775507ed1f950
