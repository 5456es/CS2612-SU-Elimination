...
Lemma add_congr: forall ( e11 e12 e21 e22: expr),
  e11 ~=~ e12 ->
  e21 ~=~ e22 ->
(EBinop OPlus e11 e12) ~=~(EBinop OPlus e21 e22).
...
(** 下面把二元运算的情况汇总起来。 one 2-obj OP, consider it as a (xy fun)node on the Grammar Tree *)
...
Check Sets_included_indexed_union .
